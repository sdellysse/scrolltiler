 ...
 */
function context_get_font_options(context: Pango.Context): any | null
/**
 ...
 */
function context_set_font_options(context: Pango.Context, options: any | null): void
/**
 ...
 */
function create_context(cr: any): Pango.Context
/**
 ...
 */
function create_layout(cr: any): Pango.Layout
/**
 ...
 */
function error_underline_path(cr: any, x: number, y: number, width: number, height: number): void
/**
 ...
 */
function font_map_new_for_font_type(fonttype: any): Pango.FontMap | null
/**
 ...
 */
function glyph_string_path(cr: any, font: Pango.Font, glyphs: Pango.GlyphString): void
/**
 ...
 */
function layout_line_path(cr: any, line: Pango.LayoutLine): void
/**
 ...
 */
function layout_path(cr: any, layout: Pango.Layout): void
/**
 ...
 * @param height Non-negative height of the rectangle
 */
function show_error_underline(cr: any, x: number, y: number, width: number, height: number): void
/**
 ...
 */
function show_glyph_item(cr: any, text: string | null, glyph_item: Pango.GlyphItem): void
/**
 ...
 * @param glyphs a `PangoGlyphString`
 */
function show_glyph_string(cr: any, font: Pango.Font, glyphs: Pango.GlyphString): void
/**
 ...
 * @param layout a Pango layout
 */
function show_layout(cr: any, layout: Pango.Layout): void
/**
 ...
 * @param line a `PangoLayoutLine`
 */
function show_layout_line(cr: any, line: Pango.LayoutLine): void
/**
 ...
 * @param context a `PangoContext`, from a pangocairo font map
 */
function update_context(cr: any, context: Pango.Context): void
/**
 ...
 */
function update_layout(cr: any, layout: Pango.Layout): void
/**
...
interface ShapeRendererFunc {
    (cr: any, attr: Pango.AttrShape, do_path: boolean): void
}
...
class FontMap {
     ...
     * @returns the newly allocated   `PangoFontMap` of suitable type which should be freed with   g_object_unref(), or %NULL if the requested cairo font backend   is not supported / compiled in.
     */
    static new_for_font_type(fonttype: any): Pango.FontMap | null
    /**
     * Gets a default `PangoCairoFontMap` to use with Cairo.
     * 
     * Note that the type of the returned object will depend on the
