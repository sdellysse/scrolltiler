...
interface StreamableContent {
     ...
     */
    get_stream(mime_type: string | null): any
    /**
     ...
     * @returns A #GIOChannel which contains the content in the specified mime type.
     */
    vfunc_get_stream(mime_type: string | null): any
    /**
     * Get a string representing a URI in IETF standard format
     * (see http://www.ietf.org/rfc/rfc2396.txt) from which the object's content
     * may be streamed in the specified mime-type, if one is available.
...
class GObjectAccessible extends Object {
     ...
     */
    static for_object(obj: any): Object
}
...
interface ObjectFactory {
     ...
     */
    create_accessible(obj: any): Object
    /**
...
interface Registry {
    ...
    parent: any
    factory_type_registry: any
    factory_singleton_cache: any
...
interface StreamableContentIface {
    ...
    get_stream: (streamable: StreamableContent, mime_type: string | null) => any
