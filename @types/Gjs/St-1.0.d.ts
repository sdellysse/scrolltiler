...
interface GenericAccessible extends Atk.Action, Atk.Component, Atk.Value {
    ...
    parent: WidgetAccessible & Cally.Actor & Atk.Object & any & any
...
interface ImageContent extends Clutter.Content {
...
interface TextureCache {
     ...
     */
    load_file_async(file: any, available_width: number, available_height: number, paint_scale: number, resource_scale: number): Clutter.Actor
    /**
     ...
     */
    load_gicon(theme_node: ThemeNode | null, icon: any, size: number, paint_scale: number, resource_scale: number): Clutter.Actor | null
    /**
     ...
     */
    load_sliced_image(file: any, grid_width: number, grid_height: number, paint_scale: number, resource_scale: number, load_callback: any | null): Clutter.Actor
    /**
...
interface WidgetAccessible extends Atk.Action, Atk.Component {
    ...
    parent: Cally.Actor & Atk.Object & any & any
