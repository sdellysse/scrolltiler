 ...
 */
function add_option_entries_libgtk_only(group: any): void
/**
 ...
 */
function cairo_create(window: Window): any
/**
 ...
 */
function cairo_draw_from_gl(cr: any, window: Window, source: number, source_type: number, buffer_scale: number, x: number, y: number, width: number, height: number): void
/**
 ...
 */
function cairo_get_clip_rectangle(cr: any): [ /* returnType */ boolean, /* rect */ Rectangle ]
/**
 ...
 */
function cairo_get_drawing_context(cr: any): DrawingContext | null
/**
 * Adds the given rectangle to the current path of `cr`.
 * @param cr a cairo context
 * @param rectangle a #GdkRectangle
 */
function cairo_rectangle(cr: any, rectangle: Rectangle): void
/**
 * Adds the given region to the current path of `cr`.
 * @param cr a cairo context
 * @param region a #cairo_region_t
 */
function cairo_region(cr: any, region: any): void
/**
 ...
 */
function cairo_region_create_from_surface(surface: any): any
/**
 ...
 */
function cairo_set_source_pixbuf(cr: any, pixbuf: GdkPixbuf.Pixbuf, pixbuf_x: number, pixbuf_y: number): void
/**
 * Sets the specified #GdkRGBA as the source color of `cr`.
 * @param cr a cairo context
 * @param rgba a #GdkRGBA
 */
function cairo_set_source_rgba(cr: any, rgba: RGBA): void
/**
 ...
 */
function cairo_set_source_window(cr: any, window: Window, x: number, y: number): void
/**
 ...
 */
function cairo_surface_create_from_pixbuf(pixbuf: GdkPixbuf.Pixbuf, scale: number, for_window: Window | null): any
/**
 ...
 */
function offscreen_window_get_surface(window: Window): any | null
/**
 ...
 */
function pixbuf_get_from_surface(surface: any, src_x: number, src_y: number, width: number, height: number): GdkPixbuf.Pixbuf | null
/**
 ...
 */
function threads_add_idle(priority: number, function_: any): number
/**
 ...
 * @returns the ID (greater than 0) of the event source.
 */
function threads_add_timeout(priority: number, interval: number, function_: any): number
/**
 ...
 * @returns the ID (greater than 0) of the event source.
 */
function threads_add_timeout_seconds(priority: number, interval: number, function_: any): number
/**
...
interface Cursor {
     ...
     */
    get_surface(): [ /* returnType */ any | null, /* x_hot */ number, /* y_hot */ number ]
    /**
...
interface Screen {
     ...
     */
    set_font_options(options: any | null): void
    /**
...
module Window {
    ...
    interface CreateSurfaceSignalCallback {
        ($obj: Window, width: number, height: number): any
    }
...
interface Window {
     ...
     */
    begin_draw_frame(region: any): DrawingContext
    /**
     ...
     */
    create_similar_image_surface(format: any, width: number, height: number, scale: number): any
    /**
     ...
     */
    get_background_pattern(): any | null
    /**
     ...
     */
    invalidate_maybe_recurse(region: any, child_func: WindowChildFunc | null): void
    /**
     ...
     */
    set_background_pattern(pattern: any | null): void
    /**
     * Sets the background color of `window`.
     * 
     ...
     */
    set_opaque_region(region: any | null): void
    /**
     ...
     * @param offset_y Y position of `shape_region` in `window` coordinates
     */
    shape_combine_region(shape_region: any | null, offset_x: number, offset_y: number): void
    /**
    ...
    vfunc_create_surface(width: number, height: number): any
...
interface WindowClass {
    ...
    create_surface: (window: Window, width: number, height: number) => any
}
