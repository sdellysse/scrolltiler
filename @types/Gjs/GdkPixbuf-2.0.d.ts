...
function pixbuf_error_quark(): any
/**
...
interface Pixbuf {
     ...
     */
    save_to_streamv(stream: any, type: string | null, option_keys: string[] | null, option_values: string[] | null, cancellable: any | null): boolean
    /**
     ...
     */
    save_to_streamv_async(stream: any, type: string | null, option_keys: string[] | null, option_values: string[] | null, cancellable: any | null, callback: any | null): void
    /**
...
class Pixbuf {
     ...
     * @returns A newly-created pixbuf
     */
    static new_from_bytes(data: any, colorspace: Colorspace, has_alpha: boolean, bits_per_sample: number, width: number, height: number, rowstride: number): Pixbuf
    /**
     ...
     * @returns A newly-created pixbuf
     */
    static new_from_stream(stream: any, cancellable: any | null): Pixbuf
    /**
     * Creates a new pixbuf by loading an image from an input stream.
     * 
     * The file format is detected automatically. If `NULL` is returned, then
     ...
     * @returns A newly-created pixbuf
     */
    static new_from_stream_at_scale(stream: any, width: number, height: number, preserve_aspect_ratio: boolean, cancellable: any | null): Pixbuf
    /**
     ...
     */
    static new_from_stream_finish(async_result: any): Pixbuf
    /**
     ...
     */
    static new_from_stream_async(stream: any, cancellable: any | null, callback: any | null): void
    /**
     * Creates a new pixbuf by asynchronously loading an image from an input stream.
     * 
     ...
     * @param callback a `GAsyncReadyCallback` to call when the pixbuf is loaded
     */
    static new_from_stream_at_scale_async(stream: any, width: number, height: number, preserve_aspect_ratio: boolean, cancellable: any | null, callback: any | null): void
    /**
     ...
     */
    static get_file_info_async(filename: string, cancellable: any | null, callback: any | null): void
    /**
     ...
     * @returns A `GdkPixbufFormat` describing the   image format of the file
     */
    static get_file_info_finish(async_result: any): [ /* returnType */ PixbufFormat | null, /* width */ number, /* height */ number ]
    /**
     ...
     * @returns `TRUE` if the pixbuf was saved successfully, `FALSE` if an error was set.
     */
    static save_to_stream_finish(async_result: any): boolean
}
...
interface PixbufAnimation {
     ...
     */
    get_iter(start_time: any | null): PixbufAnimationIter
    /**
     ...
     * @returns an iterator to move over the animation
     */
    vfunc_get_iter(start_time: any | null): PixbufAnimationIter
...
class PixbufAnimation {
     ...
     * @returns A newly-created animation
     */
    static new_from_stream(stream: any, cancellable: any | null): PixbufAnimation
    /**
     ...
     */
    static new_from_stream_finish(async_result: any): PixbufAnimation
    /**
...
interface PixbufAnimationIter {
     ...
     */
    advance(current_time: any | null): boolean
    /**
     ...
     * @returns `TRUE` if the image may need updating
     */
    vfunc_advance(current_time: any | null): boolean
    /**
     * Gets the number of milliseconds the current pixbuf should be displayed,
     * or -1 if the current pixbuf should be displayed forever.
     * 
...
interface PixbufLoader {
     ...
     * @returns `TRUE` if the write was successful, or `FALSE` if   the loader cannot parse the buffer
     */
    write_bytes(buffer: any): boolean
...
interface PixbufAnimationClass {
    ...
    get_iter: (animation: PixbufAnimation, start_time: any | null) => PixbufAnimationIter
}
...
interface PixbufAnimationIterClass {
    ...
    advance: (iter: PixbufAnimationIter, current_time: any | null) => boolean
}
