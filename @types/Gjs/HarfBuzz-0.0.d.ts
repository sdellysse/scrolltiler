 ...
 */
function ft_face_create(ft_face: any): face_t
/**
 * Creates an #hb_face_t face object from the specified FT_Face.
 * 
 ...
 */
function ft_font_create(ft_face: any): font_t
/**
 * Creates an #hb_font_t font object from the specified FT_Face.
 * 
 * <note>Note: You must set the face size on `ft_face` before calling
 ...
 */
function glib_blob_create(gbytes: any): blob_t
/**
 ...
 */
function glib_script_from_script(script: script_t): any
/**
 ...
 */
function glib_script_to_script(script: any): script_t
/**
