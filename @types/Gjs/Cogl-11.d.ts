...
function scanout_error_quark(): any
function set_tracing_disabled_on_thread(main_context: any): void
function set_tracing_enabled_on_thread(main_context: any, group: string | null, filename: string | null): void
function set_tracing_enabled_on_thread_with_fd(main_context: any, group: string | null, fd: number): void
/**
...
interface Framebuffer {
     ...
     */
    get_modelview_matrix(): /* matrix */ any
    /**
     * Stores the current projection matrix in `matrix`.
     */
    get_projection_matrix(): /* matrix */ any
    /**
...
interface Onscreen {
    ...
    parent_instance: Framebuffer & any
...
interface Pipeline {
     ...
     */
    set_layer_matrix(layer_index: number, matrix: any): void
...
interface Texture2D extends Texture {
    ...
    egl_image_external_alloc_finish(user_data: any | null, destroy: any): void
...
class _TextureVertexSizeCheck {
    ...
    type UserDataDestroyCallback = any
/**
